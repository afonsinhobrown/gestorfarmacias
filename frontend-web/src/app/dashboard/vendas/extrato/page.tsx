...
export default function ExtratoVendasPage() {
    ...
    const fetchExtrato = async () => {
        ...
        try {
            ...
            if (metodoPagamento) params.append('forma_pagamento', metodoPagamento);

            const res = await api.get(`/pedidos/extrato/?${params.toString()}`);
    ...
    const exportarCSV = () => {
        ...
        window.open(`${api.defaults.baseURL}/pedidos/extrato/?${params.toString()}`, '_blank');
    };
    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-2xl font-black text-gray-900 tracking-tight">Extrato de Vendas</h1>
                ...
                <div className="flex gap-2">
                    ...
                    <button onClick={exportarCSV} className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-xl text-xs font-bold hover:bg-blue-700 shadow-lg shadow-blue-100 transition-all">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col md:flex-row gap-4 items-end">
                <div>
                    ...
                    >
                        ...
                        <option value="CREDITO">CRÉDITO / CONTA CORRENTE</option>
                    </select>
                </div>
            </div>
